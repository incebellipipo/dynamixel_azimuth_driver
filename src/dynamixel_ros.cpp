    ...
    : node_(node), servo_config_(config)
{
    ...
    timer_ = node_->create_wall_timer(100ms, std::bind(&DynamixelServoRos::timer_callback, this));
...
void DynamixelServoRos::setup_parameters()
{
    param_callback_handlers_.push_back(
